...
Public Class Shoes
    ...
    Public p0 As Integer = 199
    Public p1 As Integer = 199
    Public p2 As Integer = 199
    Public p3 As Integer = 199
    Public p4 As Integer = 199
    Public p5 As Integer = 159
    Public p6 As Integer = 199
    Public p7 As Integer = 159
    Public p8 As Integer = 199
    Public p9 As Integer = 199
    Public p10 As Integer = 99
    Public p11 As Integer = 99
    Public p12 As Integer = 259
    Public p13 As Integer = 199
        ...
        Select Case ComboBox1.SelectedIndex
            Case 0
                If c0 > 0 Then
                    ...
                    Label2.Text = "Count for shop this product : " & c0
                    sum = sum + p0
                    Payment.RG = sum + Accessiores.sum + Simloot.sum + Jeans.sum + Sarigim.sum
    ...
    Private Sub Shoes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Label3.Text = "Total Cost :" & Payment.RG
