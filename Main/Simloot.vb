...
Public Class Simloot
    Public sum As Double = 0
    Private Sub Button1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Me.Hide()
    End Sub
    Dim speaker4 As New SpeechSynthesizer
    Dim WithEvents reco5 As New Recognition.SpeechRecognitionEngine
    Private Sub Simloot_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Label3.Text = "Total Cost :" & Payment.RG

        Dim gram3 As New Recognition.SrgsGrammar.SrgsDocument
        Dim orders As New Recognition.SrgsGrammar.SrgsRule("orders")
        Dim grammar As New Recognition.SrgsGrammar.SrgsOneOf("List", "Like", "remove", "checkout", "next", "back", "Home", "sign out")
        speaker4.SelectVoiceByHints(VoiceGender.Male, VoiceAge.Adult)
        reco5.SetInputToDefaultAudioDevice()
        orders.Add(grammar)
        gram3.Rules.Add(orders)
        gram3.Root = orders
        reco5.LoadGrammar(New Recognition.Grammar(gram3))
    ...
    Public p0 As Integer = 129
    Public p1 As Integer = 99
    Public p2 As Integer = 99
    Public p3 As Integer = 129
    Public p4 As Integer = 159
    Public p5 As Integer = 99
    Public p6 As Integer = 99
    Public p7 As Integer = 159
    Public p8 As Integer = 129
    Public p9 As Integer = 199
    Public p10 As Integer = 199
    Public p11 As Integer = 159
    Public p12 As Integer = 159
    Public p13 As Integer = 159
    Public p14 As Integer = 199
        ...
        Select Case ComboBox1.SelectedIndex
            Case 0
                If c0 > 0 Then
                    ...
                    Label2.Text = "Count for shop this product : " & c0
                    sum = sum + p0
                    Payment.RG = sum + Accessiores.sum + Shoes.sum + Jeans.sum + Sarigim.sum
                    Label3.Text = "Total Cost :" & (Payment.RG)
            ...
            Case 12
                If c12 > 0 Then
                    ...
                    sum = sum + p12
                    Payment.RG = sum + Accessiores.sum + Shoes.sum + Jeans.sum + Sarigim.sum
                    Label3.Text = "Total Cost :" & sum + Accessiores.sum + Shoes.sum + Jeans.sum + Sarigim.sum
    ...
    End Sub
    Private Sub reco5_RecognizeCompleted(ByVal sender As Object, ByVal e As System.Speech.Recognition.RecognizeCompletedEventArgs) Handles reco5.RecognizeCompleted

    End Sub
    Dim i As Integer = 0
    Private Sub reco_SpeechRecognized(ByVal sender As Object, ByVal e As System.Speech.Recognition.RecognitionEventArgs) Handles reco5.SpeechRecognized
        ...
        Select Case e.Result.Text
            ...
            Case "back"
                ...
                End If
            Case Else
                reco5.RecognizeAsync()

        End Select
    End Sub

    Private Sub Simloot_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub OFFToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OFFToolStripMenuItem.Click
        reco5.RecognizeAsyncStop()
    End Sub

    Private Sub Simloot_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed


    End Sub

    Private Sub reco5_RecognizeCompleted(ByVal sender As Object, ByVal e As Recognition.RecognitionEventArgs)
