...
Public Class Jeans
    ...
    Public p0 As Integer = 49
    Public p1 As Integer = 299
    Public p2 As Integer = 99
    Public p3 As Integer = 139
    Public p4 As Integer = 99
    Public p5 As Integer = 99
    Public p6 As Integer = 99
    Public p7 As Integer = 259
    Public p8 As Integer = 259
    Public p9 As Integer = 139
    Public p10 As Integer = 299
    Public p11 As Integer = 259
    Public p12 As Integer = 169
    Public p13 As Integer = 299
    Public p14 As Integer = 259
        ...
        Select Case ComboBox1.SelectedIndex
            Case 0
                If c0 > 0 Then
                    ...
                    Label2.Text = "Count for shop this product : " & c0
                    sum = sum + p0
                    Payment.RG = sum + Accessiores.sum + Simloot.sum + Shoes.sum + Sarigim.sum
    ...
    Private Sub Jeans_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Label3.Text = "Total Cost :" & Payment.RG
        ...
        Select Case ComboBox1.SelectedIndex
            Case 0
                If c0 < 15 Then
                    ...
                    Label2.Text = "Count for shop this product : " & c0
                    sum = sum - p0
                    Payment.RG = sum + Accessiores.sum + Shoes.sum + Simloot.sum + Sarigim.sum
                    Label3.Text = "Total Cost :" & (Payment.RG)
    ...
    Private Sub Jeans_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
